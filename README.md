...
## Plan
Leverage the capability already included in [https://labs.withsecure.com/tools/chainsaw] (Chainsaw) to scan JSON formatted exports from Carbon Black EDR via API with Sigma rules.
